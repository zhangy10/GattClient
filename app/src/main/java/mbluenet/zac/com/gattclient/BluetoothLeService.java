...
//            UUID.fromString(SampleGattAttributes.HEART_RATE_MEASUREMENT);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (SampleGattAttributes.TIME_SERVICE.equals(characteristic.getUuid())) {
    ...
    public boolean initialize() {
        ...
        if (mBluetoothManager == null) {
            ...
            if (mBluetoothManager == null) {
                log.d("Unable to initialize BluetoothManager.");
                return false;
            }
        }
        ...
        if (mBluetoothAdapter == null) {
            log.d("Unable to obtain a BluetoothAdapter.");
            return false;
        }

        connectOp = new GattConnect();
    ...
    public boolean connect(final String address) {
        if (mBluetoothAdapter == null || address == null) {
            log.d("BluetoothAdapter not initialized or unspecified address.");
            return false;
        }
    ...
    public GattConnect getConnection() {
        return connectOp;
    }
    ...
    public class GattConnect {
        ...
        public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
            ...
            log.d("readCharacteristic data: " + characteristic.getValue());
        ...
        public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
            ...
            log.d("setCharacteristicNotification data: " + characteristic.getValue());
            ...
            if (SampleGattAttributes.TIME_SERVICE.equals(characteristic.getUuid())) {
                ...
                log.d("writeDescriptor data: " + descriptor.getValue());
