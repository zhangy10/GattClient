...
//    public static UUID NETWORK_INFO = UUID.fromString("00002b0f-0000-1000-8000-00805f9b34fb");
    ...
    static {
        // Sample Services.
        attributes.put(MDL_SERVICE.toString(), "MDL Service");
//        attributes.put(NETWORK_INFO.toString(), "Network");
        attributes.put(RES_INFO.toString(), "Resource");
        attributes.put(RES_NOTICE.toString(), "Resource Notice");
    }
